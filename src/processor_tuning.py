...
class SCR1_Tuner:
    ...
    def __init__(self, tunable_params, shift_amount, generation_path, vivado_project_path):
        ...
        self.generated_logfile = '../processors/Logs/'
        self.configuration_file = '/home/hw1020/Documents/Configurable-Processor-Design-Platform-and-Dataset/processors/scr1/src/includes/scr1_arch_description.svh'
